...
class NetketOperatorWrapper(Operator):
    ...
    def random_states(self, num_of_states):
        return super(NetketOperatorWrapper, self).random_states(num_of_states)
    ...
    def find_conn(self, sample):
        ...
        for i in range(batch_size):
            ...
            # print(sample_mel, to_change_idx_list, to_change_vals_list)
            # import numpy as np
            # print(np.real(self.netket_operator.to_dense()))
