...
net_arg.add_argument('--model_name', '-m', type=str, choices=["rbm","drbm","dnn","ar","my_rbm"], default='drbm', help='Model architecture')

# Data
data_arg = add_argument_group('Data')
data_arg.add_argument('--batch_size', '-b', type=int, default=128, help='The batch size in each iteration')
data_arg.add_argument('--input_size', '-i', type=int, default=20, help='Number of spins in the input')
...
train_arg.add_argument('--use_stochastic_reconfiguration', '-sr',  action='store_true', help='Use stochastic Reconfiguration')
