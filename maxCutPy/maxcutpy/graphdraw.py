...
def draw_cut_graph(G,
    ...
    #                        width=edge_width,
    #                        edge_color='blue')
    edges = nx.edge_boundary(G, blue_nodes, blue_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='grey')
    ...
    #                        width=edge_width,
    #                        edge_color='black')
    edges = nx.edge_boundary(G, black_nodes, black_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='grey')
    ...
    #                        style='dotted',
    #                        edge_color='magenta')
    edges = nx.edge_boundary(G, undecided_nodes, undecided_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='magenta')

    edges = nx.edge_boundary(G, blue_nodes, undecided_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='magenta')

    edges = nx.edge_boundary(G, undecided_nodes, black_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='magenta')
    ...
    #                        width=edge_width,
    #                        edge_color='red')
    edges = nx.edge_boundary(G, marked_nodes, marked_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='grey')
    ...
    edges = nx.edge_boundary(G, marked_nodes, blue_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='orange')

    edges = nx.edge_boundary(G, marked_nodes, black_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='orange')

    edges = nx.edge_boundary(G, marked_nodes, undecided_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='orange')
    ...
    #                        style='dashed',
    #                        edge_color='gray')
    edges = nx.edge_boundary(G, blue_nodes, black_nodes)
    edges = [(s,e) for (s,e) in edges]
    nx.draw_networkx_edges(G, pos,edges,width=edge_width,edge_color='black')
